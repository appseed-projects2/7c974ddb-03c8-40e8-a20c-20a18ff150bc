...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-10 09:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7c974ddb-03c8-40e8-a20c-20a18ff150bc.git
$ cd 7c974ddb-03c8-40e8-a20c-20a18ff150bc
```
